...
create_root_dirnode = "_$Root_level$ = tree.createNode('$nodeName$',false,'../packages/doc_tree/jquery-tree/images/folder.png',null,null,'context1');"
create_root_unlink_filnode = "_$Root_level$ = tree.createNode('$nodeName$',false,'../packages/doc_tree/jquery-tree/images/file.png',null,null,'context1');"
create_root_link_filnode = '''_$Root_level$ = tree.createNode("<a href = '$LinkPath$' target = 'right'>$nodeName$</a>",false,'../packages/doc_tree/jquery-tree/images/file.png',null,null,'context1');'''

create_child_dirnode = "_$Root_level$ = $fatherNode$.createChildNode('$nodeName$',false,'../packages/doc_tree/jquery-tree/images/folder.png',null,'context1');"
create_child_unlink_filnode = "_$Root_level$ = $fatherNode$.createChildNode('$nodeName$',false,'../packages/doc_tree/jquery-tree/images/file.png',null,'context1');"
create_child_link_filnode = '''_$Root_level$ = $fatherNode$.createChildNode("<a href = '$LinkPath$' target = 'right'>$nodeName$</a>",false,'../packages/doc_tree/jquery-tree/images/file.png',null,'context1');'''
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../packages/doc_tree/jquery-tree/css/default.css">
	<link rel="stylesheet" type="text/css" href="../packages/doc_tree/jquery-tree/css/Aimara.css">
	<link rel="stylesheet" type="text/css" href="../packages/doc_tree/jquery-tree/css/Example.css">
	<script src="../packages/doc_tree/jquery-tree/lib/Aimara.js" type="text/javascript"></script>
	...
	<!--[if IE]>
		<script src="../packages/doc_tree/jquery-tree/lib/html5shiv.min.js"></script>
	<![endif]-->
</head>
<body>
